...
<section class="privacy">
  <div class="container">
    ...
    <br />
    <p>
      Your privacy is important to us. It is 021.inc policy to respect
      ...
      website,
      <a href="https://021.inc"
      >https://021.inc</a
      >, and other sites we own and operate.
    </p>
    <p>
      This policy is effective as of 12 May 2021 and was last updated on 12 May
      2021.
    </p>
    ...
    <p>
      We respect your privacy. We will only use information you provide through
      the Program to transmit your mobile messages and respond to you, if
      necessary. This includes, but is not limited to, sharing information with
      platform providers, phone companies, and other vendors who assist us in
      the delivery of mobile messages. WE DO NOT SELL, RENT, LOAN, TRADE, LEASE,
      OR OTHERWISE TRANSFER FOR PROFIT ANY PHONE NUMBERS OR CUSTOMER INFORMATION
      COLLECTED THROUGH THE PROGRAM TO ANY THIRD PARTY. Nonetheless, We reserve
      the right at all times to disclose any information as necessary to satisfy
      ...
      otherwise provide Us information in connection with the Program, you agree
      to provide accurate, complete, and true information. You agree not to use
      a false or misleading name or a name that you are not authorized to use.
      If, in Our sole discretion, We believe that any such information is
      untrue, inaccurate, or incomplete, or you have opted into the Program for
      an ulterior purpose, We may refuse you access to the Program and pursue
      any appropriate legal remedies. Text Marketing and notifications (if
      applicable): By entering your phone number in the checkout and
      initialising a purchase, you agree that we may send you text notifications
      (for your order, including abandoned cart reminders) and text marketing
      offers. Text message frequency may vary. You can unsubscribe from further
      text messages by replying STOP. Message and data rates may apply. In
      addition, the Website uses cookies to help keep track of items you put in
      your shopping cart and to tell us if you have visited the Website in the
      past. This allows visitors to the online store to maintain shopping carts
      between visits. You can refuse cookies by turning them off in your
      browser. California Civil Code Section 1798.83 permits Users of the
      Program that are California residents to request certain information
      regarding our disclosure of the information you provide through the
      Program to third parties for their direct marketing purposes.
    </p>
    <h3>Contact Us</h3>
    <p>
    ...
    <p>
      30 N Gould St Suite 1976, Sheridan, WY 82801, United States,
      <a href="mailto:hello@021.inc" class="linked"
      > hello@021.inc</a
      >
    </p>
    <h3>Other</h3>
    <p>
      This Privacy Policy is strictly limited to the Program and has no effect
      on any other privacy policy(ies) that may govern the relationship between
      you and Us in other contexts. If our store is acquired or merged with
      another company, your information may be transferred to the new owners so
...
.privacy {
  ...
  h2 {
    ...
    font-weight: 700;
    @media(min-width: 768px){
      font-size: calc(20px + (36 - 20) * ((100vw - 480px) / (1920 - 480)));
    }
  }
  p {
    font-size: 14px;
