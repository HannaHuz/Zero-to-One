    ...
    <div class="container">
      ...
      <div v-if="step === 1">
        <form class="step step-one" @submit="stepOne">
          ...
          <div class="field animated del-50" data-anim="fadeInLeft">
            <input type="text" v-model="companyName" id="company" minlength="2" maxlength="30" required>
            <label for="company" :class="(companyName && companyName.length > 0)? 'active':''">Company name<span>*</span></label>
          </div>
          <div class="btn animated del-70" data-anim="fadeInLeft">
            <svg width="148" height="133" viewBox="0 0 148 133" fill="none" xmlns="http://www.w3.org/2000/svg" class="btn-anim"><path d="M147.25 66.5C147.25 102.739 114.532 132.25 74 132.25C33.4677 132.25 0.75 102.739 0.75 66.5C0.75 30.2607 33.4677 0.75 74 0.75C114.532 0.75 147.25 30.2607 147.25 66.5Z" stroke="#332F2D" stroke-width="1.5" /></svg>
            <input type="submit" value="Continue">
            <svg class="btn-arrow" width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.5 7L22.5 7M22.5 7C20.6341 7 16.5 8.5 16.5 12.5M22.5 7C20.6341 7 16.5 5.5 16.5 1.5" stroke="#DDD9D2" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" /></svg>
          </div>
        </form>
      </div>
      <div v-else-if="step === 2">
        <form class="step step-two" @submit="stepTwo">
          <div class="field animated del-30" data-anim="fadeInLeft">
            ...
            <label for="email" :class="(emailAddress && emailAddress.length > 0)? 'active':''">Email<span>*</span></label>
          </div>
          <div class="field animated del-50" data-anim="fadeInLeft">
      ...
      Request.addTask(quizData)
        .then(result => {
          ...
          if (result.status === 'success') {
            this.step = false;
            this.title = 'Thank you <br>for your <br>message!'
...
.active {
  .btn-anim path {
    ...
    animation: 2s linear forwards stroke;
    animation-delay: 1s;
  }
  @keyframes stroke {
    100% {
